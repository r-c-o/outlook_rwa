...
pug_rows = [
    ("Banking [L2]",   12214, "Investment Banking [L3]",         2067,  "Debt Capital Markets [L4]"),
    ("Banking [L2]",   12214, "Investment Banking [L3]",         2068,  "Equity Capital Markets [L4]"),
    ("Banking [L2]",   28614, "Corporate Lending [L3]",          39384, "Commercial Banking [L4]"),
    ("Banking [L2]",   28614, "Corporate Lending [L3]",          39385, "Mid-Corp Lending [L4]"),
    ("Services [L2]",  28610, "Securities Services [L3]",        25457, "Custody [L4]"),
    ("Services [L2]",  28610, "Securities Services [L3]",        22928, "Fund Services [L4]"),
    ("Services [L2]",  3891,  "Treasury and Trade Solutions [L3]", 3899, "Payments [L4]"),
    ("Services [L2]",  3891,  "Treasury and Trade Solutions [L3]", 57742,"Total Liquidity [L4]"),
    ("Markets [L2]",   14001, "Fixed Income [L3]",               14002, "Rates [L4]"),
    ("Markets [L2]",   14001, "Fixed Income [L3]",               14003, "Credit [L4]"),
    ("Wealth [L2]",    20001, "Private Bank [L3]",               20002, "UHNW [L4]"),
    ("All Other [L2]", 4921,  "Legacy Franchises [L3]",          8278,  "Legacy Holdings Assets [L4]"),
]
...
bs_df = pd.DataFrame({
    ...
    "YEAR": [2025] * n,
    "Balance Type": ["ABL"] * n,
    "Managed Segment L1 Descr": ["Citigroup [L1]"] * n,
    ...
    "Managed Geography L1 Descr": ["Global [L1]"] * n,
    "Managed Geography L2 Descr": rng.choice(["North America [L2]", "EMEA [L2]", "Asia Pacific [L2]"], n),
    "Managed Geography L3 Descr": rng.choice(["NAM", "Europe", "Japan Asia Pacific", "Latin America"], n),
    ...
    "Managed Geography L3  Id": rng.integers(100, 999, n),
...
quarters = ["Mar 2025", "Jun 2025", "Sep 2025", "Dec 2025"]
...
conv_df = pd.DataFrame({
    ...
    "Version Number": rng.integers(1, 10, n),
    "Data Category": rng.choice(["Internal", "External"], n),
    "RWA Exposure Type Description": rng.choice(["Credit Risk", "Market Risk", "Operational Risk"], n),
    "Projected Quarter": rng.choice(quarters, n),
    "Fiscal Year Accounting Period": rng.integers(202501, 202512, n),
    "Scenario Id": rng.choice(["CHALLENGER", "BASELINE", "ADVERSE"], n),
    "Scenario Name": rng.choice(["CHALLENGER", "BASELINE", "ADVERSE"], n),
    "Quarter Id": rng.integers(0, 4, n),
    "Error Flag": [""] * n,
    ...
    "Managed Segment Level 2 Description": rng.choice(["Banking [L2]", "Services [L2]", "Markets [L2]", "All Other [L2]"], n),
    "Managed Segment Level 3 Description": rng.choice(["Corporate Lending [L3]", "Securities Services [L3]", "Legacy Franchises [L3]"], n),
    "Managed Geography Level 3 Description": rng.choice(["NAM", "Europe", "Japan Asia Pacific", "Latin America"], n),
